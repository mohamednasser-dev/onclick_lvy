...
@section('content')
    <div class="content container-fluid">
        <!-- Page Header -->
        @if(UserCan('add_attribute','admin'))
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{trans('messages.add')}} {{trans('messages.new')}} {{trans('messages.attribute')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                @if(UserCan('edit_attribute','admin'))
                                                <a class="dropdown-item"
                                                   href="{{route('admin.attribute.edit',[$attribute['id']])}}">{{trans('messages.edit')}}</a>
                                                @endif
                                                    @if(UserCan('delete_attribute','admin'))
                                                    <a class="dropdown-item" href="javascript:"
                                                   onclick="form_alert('attribute-{{$attribute['id']}}','Want to delete this attribute ?')">{{trans('messages.delete')}}</a>
                                                    @endif
