                ...
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{trans('messages.sslcommerz')}} {{trans('messages.payment')}}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1" {{$config['status']==1?'checked':''}}>
                                    <label style="padding-left: 10px">{{trans('messages.active')}}</label>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form action="{{route('admin.business-settings.payment-method-update',['stripe'])}}"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{trans('messages.api')}} {{trans('messages.key')}}</label><br>
