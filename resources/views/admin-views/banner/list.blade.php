                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item"
                                                   href="{{route('admin.banner.edit',[$banner['id']])}}">{{trans('messages.edit')}}</a>
                                                @endif
                                                    @if(UserCan('delete_banner','admin'))
                                                    <a class="dropdown-item" href="javascript:"
                                                   onclick="form_alert('banner-{{$banner['id']}}','Want to delete this banner')">{{trans('messages.delete')}}</a>
                                                    @endif
