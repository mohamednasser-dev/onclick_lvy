                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" class="form-control" placeholder="New Sub Category in English"
                                       required>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_ar" class="form-control" placeholder="New Sub Category In Arabic"
                                       >
                            </div>
                            <input name="position" value="1" style="display: none">
                        </div>
