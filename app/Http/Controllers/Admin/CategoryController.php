...
class CategoryController extends Controller
{
    ...
    function store(Request $request)
    {
        $request->validate([
            ...
            'name.required' => 'Name in english is required!',
        ]);
        ...
        if ($request->has('image')) {
            ...
            $category->name_ar = ($request->name_ar)?$request->name_ar:$request->name ;
            $category->name = ($request->name)?$request->name:$request->name_ar ;
